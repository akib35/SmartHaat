<template>
    <v-container fluid>
      ...
      <v-card tile class=" text-xs-center mx-16 mt-1
       card1" color="white">
        <v-layout row wrap>
            <v-flex cols-12>
            <v-carousel cycle class="carousel" hide-delimiter-background="" height="500px" show-arrows="hover" style="width: 1360px">
                <v-carousel-item
                 v-for="(img,i) in imgs"
                 :key="i"
                :src="img.src"
          ...
          <div class="text-h3 white-text">
            {{ img.title }} 
            <v-breadcrumbs :items="Links" class="white-text mt-0 text-h5" justify="center">
            <template v-slot:divider>
              <v-icon color="#7C92FE">mdi-chevron-right</v-icon>
            </template>
        </v-breadcrumbs>
        ...
        <v-row>
          ...
          <v-col cols="12" sm="3" class="mt-1 px-0">
            <v-toolbar flat outlined>
          ...
          <v-col cols="12" sm="3" class="mt-1 pl-0">
            <v-toolbar flat outlined>
              <v-divider vertical></v-divider>
              <v-btn icon class="button">
            ...
            <v-row>
              ...
              >
                <v-hover v-slot: default="{ hover }">
                  <v-card height="300" class="justify-center" flat outline tile>
                    <v-card-actions>
                      <v-spacer></v-spacer>
                      <v-btn color="black" small dark>{{ cattle.sold }}</v-btn>
                    </v-card-actions>
                    <v-img src="Cow-5.jpg" width="200" height="200" contain ></v-img>
                    <v-card-text class="blue mx-auto mt-4">
                      <strong :class="hover ? 'red--text' : 'black--text'">{{cattles.title}}</strong>
                    </v-card-text>
                    <v-expand-transition>
                      <div
                        v-if="hover"
                        class="d-flex. transition-fast-in-fast-out blue v-card--reveal display-3 text-white"
                        style="height: 100%"
                      >
      ...
      <v-card color="#EFF0F2" height="250px" tile flat dark class="d-flex justify-center mt-0 card2">
          <v-row>
              <v-col cols="12" sm="12">
                  <h4 class="text-center text-black mt-10">SUBSCRIBE TO OUR NEWSLETTER</h4>
              </v-col>
              <v-col cols="12" sm="12"
              ><h6 class="text-center text-grey">Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptatum consequuntur cupiditate sapiente nobis natus doloremque rem modi repellendus earum! Enim.</h6>
              </v-col>
                <v-responsive
                    class="mx-auto"
                    max-width="344"
